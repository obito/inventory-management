...
.legend-dot.operational { background: var(--color-status-stable-text); }
.legend-dot.labor { background: var(--color-stat-success); }
.legend-dot.overhead { background: var(--color-stat-warning); }
.legend-dot.revenue-color { background: var(--color-accent); }
.legend-dot.cost-color { background: var(--color-stat-danger); }
...
.revenue-card {
  border-left: 4px solid var(--color-panel-text-heading);
}
...
.bar-segment.operational { background: var(--color-status-stable-text); }
.bar-segment.labor { background: var(--color-stat-success); }
.bar-segment.overhead { background: var(--color-stat-warning); }
